    ...
    <el-row :getter="20">
      ...
      <el-col :span="16">
        ...
        <div class="two_chart">
          ...
          <el-card shadow="hover">
            <div style="height: 240px;" ref="vedioEchart"></div>
          </el-card>
        </div>
      </el-col>
    </el-row>
  ...
  methods: {
    getTable () {
      getHome().then((res) => {
        ...
        // console.log("--------",this.echartData.order.xAxis.data);
        ...
        const myEchartsOrder = echarts.init(this.$refs.line_echart)
        myEchartsOrder.setOption(this.echartData.order)

        // 柱状图的实现
        this.echartData.user.xAxis.data = res.data.userData.map((item) => item.date)
        ...
        myEchartsUser.setOption(this.echartData.user)
        ...
        myEchartsVedio.setOption(this.echartData.vedio)
      })
    },
    drawPid (id) {
